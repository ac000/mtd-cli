...
::
   ...
   mtd-cli init|init-creds|init-oauth|init-nino|bd|biss|bsas|ical|id|ie|iei|ifi|ilos|ioi|ipi|isb|isi|ob|pb|saa|saass|said|seb|vat|test_cu|test_fph|test_sa
