...
::
   ...
   mtd-cli init|init-creds|init-oauth|init-nino|bd|biss|bsas|cisd|ical|id|idi|ie|iei|ifi|iipi|ilos|ioi|ipi|isb|isi|ob|od|pb|saa|saass|said|seb|vat|test_cu|test_fph|test_sa
